...
points(wfso$nx3[r1],wfso$ny3[r1],col = adjustcolor( "red", alpha.f = 1) )
points(wfso$nx3[r2],wfso$ny3[r2],col = adjustcolor( "blue", alpha.f = 1))
points(wfso$nx3[r3],wfso$ny3[r3],col = adjustcolor( "green", alpha.f = 1))
points(wfso$nx3[r4],wfso$ny3[r4],col = adjustcolor( "purple", alpha.f = 1))
points(wfso$nx3[r5],wfso$ny3[r5],col = adjustcolor( "orange", alpha.f = 1))
points(wfso$nx3[r6],wfso$ny3[r6],col = adjustcolor( "yellow", alpha.f = 1))
